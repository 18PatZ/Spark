...
Spark handles all of the redundant overhead logic that all plugins have to deal with. By hooking into Spark, developing plugins becomes much smoother and more efficient.
